...
// to consumers.
//
// Generated from INFORMATION_SCHEMA.COLLATIONS on MySQL 8.0 and 8.4
// (identical 286-row sets). Collation ids are append-only and stable
// across MySQL versions. Regenerate with:
