...
function Gtid(parser, options, zongji) {
  BinlogEvent.apply(this, arguments);
...
util.inherits(Gtid, BinlogEvent);

function AnonymousGtid(parser, options, zongji) {
  BinlogEvent.apply(this, arguments);
  this.flags = parser.parseUnsignedNumber(1);
  this.sid = formatUuid(parser.parseBuffer(16));
  this.gno = parser.parseUnsignedNumber(8);
...
util.inherits(AnonymousGtid, BinlogEvent);

function PreviousGtids(parser, options, zongji) {
  BinlogEvent.apply(this, arguments);
...
util.inherits(PreviousGtids, BinlogEvent);
...
exports.Gtid = Gtid;
exports.AnonymousGtid = AnonymousGtid;
exports.PreviousGtids = PreviousGtids;
