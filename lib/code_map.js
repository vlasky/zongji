...
const EventClass = {
  ...
  QUERY_COMPRESSED_EVENT: events.QueryCompressed,
  WRITE_ROWS_COMPRESSED_EVENT_V1: events.RowsCompressed,
  UPDATE_ROWS_COMPRESSED_EVENT_V1: events.RowsCompressed,
  DELETE_ROWS_COMPRESSED_EVENT_V1: events.RowsCompressed,
  WRITE_ROWS_COMPRESSED_EVENT: events.RowsCompressed,
  UPDATE_ROWS_COMPRESSED_EVENT: events.RowsCompressed,
  DELETE_ROWS_COMPRESSED_EVENT: events.RowsCompressed,
};
